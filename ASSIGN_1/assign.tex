...
Let B represents the event "the two numbers appearing on throwing two dice are different".\\
$A=\{13,22,31\}$ ,n(A)=3 \\
\begin{align*}
\pr{A}=\frac{n(A)}{n(S)}=\frac{3}{36} 
\end{align*}
\begin{align*}
B=
\begin{bmatrix}
...
A \cap B=\{13,31\} \implies n(A \cap B)=2 
\end{align*}
\begin{align*}
...
\end{align*}
\begin{align*}
\pr{A/B}=\frac{\frac{2}{36}}{\frac{30}{36}}=\frac{2}{30}=\frac{1}{15}
\end{align*}
\end{document}
