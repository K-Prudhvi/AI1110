...
\begin{align}
  ...
  n(X_1=X_2)&=6  \label{eq:6} \\
\pr{X_1 \neq X_2}&=1-\pr{X_1=X_2} 
\end{align}
From \eqref{eq:6}
\begin{align} 
&=1-\frac{6}{36}  \\
&=\frac{30}{36}  \label{eq:9} \\
{(X=4)},(X_1 \neq X_2)&=\{(1,3),(3,1)\} \\
n({(X=4)},(X_1 \neq X_2))&=2 \\ 
\pr{(X=4),(X_1 \neq X_2)}&=\frac{2}{36} \label{eq:12}
\end{align}
\begin{table}[htbp]
...
\begin{align}
\pr{(X=4)|(X_1 \neq X_2)}=\frac{\pr{(X=4),(X_1 \neq X_2)}}{\pr{X_1 \neq X_2}} \label{eq:13}
\end{align}
Substituting \eqref{eq:9} and \eqref{eq:12} in \eqref{eq:13}
\begin{align}
